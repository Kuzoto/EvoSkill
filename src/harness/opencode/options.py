...
def build_opencode_options(
    *,
    ...
    system_with_dirs += (
        ...
        "driver from Italy who drove a Ferrari 312T and shares a last name with "
        "a common cocktail drink?\n"
        "Assistant thinking: This is a complex, multi-hop research question. "
        "I should use the research-methodology skill to decompose and verify each step.\n"
        "Assistant action: Skill({\"skill\": \"research-methodology\", \"args\": \"<the question>\"})\n"
        "Result: Skill launches and provides a systematic workflow. "
        "The assistant then follows the methodology to research and verify.\n\n"
        "### Example 2: Quantitative question\n"
        "User: How many volcanic eruptions in the 21st century have produced a "
        "plume height of at least 18 miles?\n"
        "Assistant thinking: This involves finding and counting items in a bounded "
        "domain. I should use the quantitative-verification skill.\n"
        "Assistant action: Skill({\"skill\": \"quantitative-verification\", "
        "\"args\": \"<the question>\"})\n"
        "Result: Skill launches and provides enumeration/verification methodology. "
        ...
        "I should use the code-testing skill for a mandatory test workflow.\n"
        "Assistant action: Skill({\"skill\": \"code-testing\"})\n"
        "Result: Skill launches and provides a test harness workflow. "
        "The assistant writes code, creates tests, and validates before submitting.\n\n"
        "Key pattern: ALWAYS invoke a relevant skill BEFORE starting your work. "
        "The skill provides a methodology that guides your approach.\n"
        "\n\n"
