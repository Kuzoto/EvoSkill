...
from src.harness import Agent, AgentTrace, is_claude_sdk, is_opencode_sdk, is_openhands_sdk, is_goose_sdk
...
and modify it to add these capabilities. Preserve all existing content that is still relevant."""
            ...
            if is_opencode_sdk() or is_openhands_sdk() or is_goose_sdk():
